          ...
          <div className="row">
            <div className="col-xl-4 col-lg-5 mb-md-50">
              <div className="brand-info">
                <h4 className="sub-title">Outils</h4>
                ...
                <h2 className="title split-text">
                  <SplitText
                    ...
                    rootMargin="-50px"
                  >
                    Nous travaillons avec les meilleurs outils
                  </SplitText>
                </h2>
                ...
                <p className="split-text">
                  <SplitText
                    ...
                    rootMargin="-50px"
                  >
                    Avec les meilleurs outils du marché, nous transformons vos
                    idées en solutions digitales puissantes et efficaces.
                  </SplitText>
                </p>
{/* Clients Card 
              ...
              <div className="client-style-one-items">
                <div className="client-style-one-item">
                  <div className="fun-fact">
                    ...
                    <span className="medium">Outils</span>
                  </div>
                </div>
                <div className="client-style-one-item">
